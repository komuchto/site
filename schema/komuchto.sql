...
-- Дамп данных таблицы komuchto.adverts: 0 rows
...
-- Дамп данных таблицы komuchto.AuthItem: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `AuthItem` DISABLE KEYS */;
INSERT INTO `AuthItem` (`name`, `type`, `description`, `bizrule`, `data`) VALUES
	('admin', 2, 'администратор', 'return Yii::app()->user->permission == 2;', 'N;'),
	('moderator', 2, 'Модератор', 'return Yii::app()->user->permission == 1;', 'N;'),
	('user', 2, 'Пользователь', 'return Yii::app()->user->permission == 0;', 'N;');
...
INSERT INTO `users` (`id`, `service`, `permission`, `identity`, `email`, `name`) VALUES
	(3, '', '2', 'https://www.google.com/accounts/o8/id?id=AItOawn6rLF6HkD0GnV1w8t626mS5Z99WkX30kc', NULL, 'Игорь');
